...
class DatosTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 1 && indexPath.row == 4{
            self.performSegue(withIdentifier: "guardarDatos", sender: self)
        }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        //asignamos el dato a una variable
        ...
        let viewController = segue.destination as! MostrarViewController
